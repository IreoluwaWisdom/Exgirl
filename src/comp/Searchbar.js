...
const SearchBar = () => {
  ...
  const listItems = [
    {
      text: "Jollof Rice",
      link: "/menu/jollof-rice",
      image: jollofrice,
      price: "₦1500",
      description: "Delicious rice dish with tomatoes and spices.",
    },
    {
      text: "Fried Rice",
      link: "/menu/fried-rice",
      image: friedrice,
      price: "₦1500",
    },
    {
      text: "Ewa Agoyin and Bread",
      link: "/menu/ewa",
      image: ewa,
      price: "₦1500",
    },
    ...
    {
      text: "White Rice and Fish Sauce",
      link: "/menu/rice",
      image: rice,
      price: "₦1500",
    },
    ...
    {
      text: "Pando Yam with Efo Riro",
      link: "/menu/pando",
      image: pando,
      price: "₦1500",
    },
    {
      text: "Amala and Ewedu",
      link: "/menu/amala",
      image: amala,
      price: "₦1500",
    },
    ...
    {
      text: "Fried Chicken",
      link: "/menu/fried-chicken",
      image: friedchicken,
      price: "₦1500",
    },
    {
      text: "Fish and Meat Sauce",
      link: "/menu/fish",
      image: fish,
      price: "₦1500",
    },
        ...
        <div key={index} className="search-item">
          ...
          >
            {favorites.includes(index) ? (
              ...
              <AiOutlineHeart className="favorite-icon-fill" />
            )}
          </button>
        </div>
      ))}
